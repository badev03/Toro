    ...
    @section('products')
            ...
            <div class="container">
                ...
                <div class="product_area">
                            ...
                            <div class="product_tab_button">
                                <ul class="nav" role="tablist">
                                    ...
                                    @foreach ($categories as $key => $category)
                                        <li>
                                            <a class="{{ isset($selectedCategory) && $category->slug == $selectedCategory->slug ? 'active' : '' }}"
                                                href="{{ route('findProductByCategory', $category->slug) }}"
                    ...
                    <div class="tab-content">
                        @foreach ($categories as $key => $category)
                            <div class="{{ isset($selectedCategory) && $category->slug == $selectedCategory->slug ? 'tab-pane fade show active' : 'tab-pane fade' }}"
        ...
        @include('clients.page.home.product-trending')
